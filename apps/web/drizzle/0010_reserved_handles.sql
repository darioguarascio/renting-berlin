...
ALTER TABLE "reserved_handles" DROP CONSTRAINT IF EXISTS "reserved_handles_user_id_users_id_fk";--> statement-breakpoint
...
SELECT "handle", "id", COALESCE("updated_at", now())
FROM "users"
