DO $$ BEGIN
  CREATE TYPE "email_tracking_event_type" AS ENUM('open', 'click');
EXCEPTION
...
END $$;--> statement-breakpoint
DO $$ BEGIN
  ALTER TABLE "email_tracking_events" ADD CONSTRAINT "email_tracking_events_send_id_email_sends_id_fk" FOREIGN KEY ("send_id") REFERENCES "public"."email_sends"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
  WHEN duplicate_object THEN NULL;
END $$;--> statement-breakpoint
